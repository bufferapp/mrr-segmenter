...
Choose what to segment MRR by. Total MRR will be grouped by the selected choices so that you can how MRR has changed over time for each combination of choices.

For example, if "Billing Interval" and "Gateway" are selected, the app will display historic MRR for monthly Stripe subscriptions, yearly Stripe subscriptions, monthly Apple subscriptions, yearly Apple subscriptions, etc.
...
If you have any questions or issues, please shoot Julian a message or log an issue here: https://github.com/jwinternheimer/mrr-segmenter
